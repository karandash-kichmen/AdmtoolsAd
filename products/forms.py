...
from .models import CarEngine, GoodsItem, CarModel
...
class GoodsItemForm(forms.ModelForm):
    ...
    #     restrict_on_form_field="carmark",
    #     restrict_on_relation="allowedcombination__carmark",
    # )
    # car_engine = RestrictedModelChoiceField(
    #     CarEngine.objects.all(),
    #     restrict_on_form_field="carmodel",
    #     restrict_on_relation="allowedcombination__carmodel",
    # )
